...
For real-time WebSocket events, see [`mailpit-ws`](https://www.npmjs.com/package/mailpit-ws).
...
| Real-time notification of any new message                   | Use [`mailpit-ws`](https://www.npmjs.com/package/mailpit-ws)                                            |
